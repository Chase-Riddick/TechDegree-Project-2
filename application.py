...
def balance_teams(experienced_players_list, inexperienced_players_list, teams_list):
    """ """
...
def generate_teams(players_list, teams_list):
    ...
    new_teams = balance_teams(experienced_players, inexperienced_players, teams_list)
